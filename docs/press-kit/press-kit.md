# Press / Media Kit — ONETOO.eu

## One‑sentence summary
ONETOO.eu is a Pan‑European Trust & Decision Infrastructure for commerce and AI — transparent, explainable, and audit‑ready.

## What it is
ONETOO.eu helps people, platforms, and AI assistants make safer shopping decisions by providing trust signals, risk intelligence (with reason codes and confidence), and EU 27/27 jurisdiction context (EU core + national overrides).

## What it is not
- Not an e‑shop
- Not only a price comparison site
